...
public class Heap implements PriorityQ  {
	...
	public static void main(String[] args) throws Exception {
		...
		HuffmanNode a = new HuffmanNode("a", 320);
		HuffmanNode b = new HuffmanNode("b", 400);
		HuffmanNode c = new HuffmanNode("c", 530);
		HuffmanNode d = new HuffmanNode("d", 670);
		HuffmanNode e = new HuffmanNode("e", 1300);
