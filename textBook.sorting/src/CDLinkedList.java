public class CDLinkedList {
	...
	public void insertionSort() {
		DListNode sortedN = header.nextNode;
		DListNode rightN = sortedN.nextNode;
		DListNode current;
		
		for (int sorted = 1; sorted < size; sorted++) {
			int temp = rightN.data;
			current = rightN;
			for(int right = sorted; right>0; right--) {
				if (current.previousNode.data > temp) {
					current.data = current.previousNode.data;
			...
			current.data = temp;
			sortedN = sortedN.nextNode;
			rightN = rightN.nextNode;
		}
	}
	...
	public static void main(String[] args) throws Exception {
		...
		cd1.insert(10, new DListIterator(cd1.header.previousNode));
		cd1.insert(3, new DListIterator(cd1.header.previousNode));
		cd1.insert(0, new DListIterator(cd1.header.previousNode));
		cd1.insert(11, new DListIterator(cd1.header.previousNode));
		cd1.insert(1, new DListIterator(cd1.header.previousNode));
